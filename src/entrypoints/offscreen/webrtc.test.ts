...
import wasmInit, { FrostDkg, FrostDkgSecp256k1 } from '../../../pkg/mpc_wallet.js'; // Corrected import
...
describe('WebRTCManager DKG Process', () => {
    ...
    it('should initialize DKG when conditions are met', async () => {
        ...
        // Set up participant index (we know localPeerId is 'a' from constructor)
    ...
    it('should handle Round 1 package reception and transition to Round 2', async () => {
        ...
        try {
            ...
            (manager as any).receivedRound1Packages.add('a'); // Corrected: use add for Set, with peerId
    ...
    it('should handle Round 2 package reception and transition to finalization', async () => {
        ...
        try {
            ...
            // Manager processes its own package first
    ...
    it('should complete full DKG process end-to-end with cryptographically realistic simulation', async () => {
        ...
        let frostDkgA: FrostDkg | null = null, frostDkgB: FrostDkg | null = null, frostDkgC: FrostDkg | null = null;
        ...
        try {
            ...
            const solanaAddressA_val = frostDkgA!.get_sol_address();
            (managerA as any).solanaAddress = solanaAddressA_val;
            const solanaAddressB_val = frostDkgB!.get_sol_address();
            (managerB as any).solanaAddress = solanaAddressB_val;
            const solanaAddressC_val = frostDkgC!.get_sol_address();
    ...
    it('should complete full Ethereum secp256k1 DKG process with 3 clear FROST rounds', async () => {
        ...
        try {
            ...
            const ethAddressA = frostDkgA!.get_eth_address(); // Corrected: was get_sol_address
            (managerA as any).ethAddress = ethAddressA; // Store on manager for consistency
            const ethAddressB = frostDkgB!.get_eth_address(); // Corrected: was get_sol_address
            (managerB as any).ethAddress = ethAddressB;
            const ethAddressC = frostDkgC!.get_eth_address(); // Corrected: was get_sol_address
