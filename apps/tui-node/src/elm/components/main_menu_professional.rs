...
#[derive(Debug, Clone)]
pub struct ProfessionalMainMenu {
    props: Props,
    items: Vec<MenuItem>,
    selected: usize,
    focused: bool,
...
impl Default for ProfessionalMainMenu {
    fn default() -> Self {
        Self::new()
    }
}

impl ProfessionalMainMenu {
    pub fn new() -> Self {
...
impl MockComponent for ProfessionalMainMenu {
...
impl Component<Message, UserEvent> for ProfessionalMainMenu {
...
impl MpcWalletComponent for ProfessionalMainMenu {
    fn id(&self) -> Id {
        Id::MainMenu
    }
