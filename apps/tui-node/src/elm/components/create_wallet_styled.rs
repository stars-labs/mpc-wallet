...
#[derive(Debug, Clone)]
pub struct StyledCreateWalletComponent {
    props: Props,
    selected: usize,
    focused: bool,
}
...
impl Default for StyledCreateWalletComponent {
    fn default() -> Self {
        Self::new()
    }
}

impl StyledCreateWalletComponent {
    pub fn new() -> Self {
    ...
    pub fn set_selected(&mut self, index: usize) {
        ...
        tracing::debug!("🎯 StyledCreateWalletComponent::set_selected: {} -> {}", old_selected, self.selected);
    }
...
impl MockComponent for StyledCreateWalletComponent {
    fn view(&mut self, frame: &mut Frame, area: Rect) {
        tracing::debug!("🎨 StyledCreateWalletComponent::view - rendering with selected: {}, focused: {}", 
...
impl Component<Message, UserEvent> for StyledCreateWalletComponent {
...
impl MpcWalletComponent for StyledCreateWalletComponent {
    fn id(&self) -> Id {
        Id::CreateWallet
    }
